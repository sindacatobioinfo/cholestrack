"""
Django settings for pdiddy project.
...
SECRET_KEY = 'django-insecure-sviax+d!c#1^4_65x+edabjz(e3n=*w!&&b1-luo34f-nyf==6'
...
WSGI_APPLICATION = 'pdiddy.wsgi.application'
